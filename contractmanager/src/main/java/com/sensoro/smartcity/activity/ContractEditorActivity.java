...
public class ContractEditorActivity extends BaseActivity<IContractEditorView, ContractEditorPresenter>
    ...
    @BindView(R2.id.ac_contract_editor_personal_contract)
    TextView acContractEditorPersonalContract;
    @BindView(R2.id.ac_contract_editor_business_contract)
    TextView acContractEditorCompanyContract;
    @BindView(R2.id.ac_contract_editor_fl)
    FrameLayout acContractEditorFl;
    @BindView(R2.id.ac_contract_editor_top_tab)
    ...
    public void showPersonalFragment() {
        acContractEditorPersonalContract.setBackgroundResource(R.drawable.shape_btn_contract_top_bottom_left_corner_2_29c_bg);
        acContractEditorPersonalContract.setTextColor(mActivity.getResources().getColor(R.color.white));
        acContractEditorCompanyContract.setBackgroundResource(R.drawable.shape_btn_contract_top_bottom_right_corner_2_white_bg);
    ...
    public void showBusinessFragment() {
        acContractEditorPersonalContract.setBackgroundResource(R.drawable.shape_btn_contract_top_bottom_left_corner_2_white_bg);
        acContractEditorPersonalContract.setTextColor(mActivity.getResources().getColor(R.color.c_a6a6a6));
        acContractEditorCompanyContract.setBackgroundResource(R.drawable.shape_btn_contract_top_bottom_right_corner_2_29c_bg);
