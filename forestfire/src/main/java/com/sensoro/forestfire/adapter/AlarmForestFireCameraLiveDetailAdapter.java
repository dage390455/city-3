...
public class AlarmForestFireCameraLiveDetailAdapter extends RecyclerView.Adapter<AlarmForestFireCameraLiveDetailAdapter.CameraLiveDetailViewHolder> {
    ...
    public AlarmForestFireCameraLiveDetailAdapter(Context context) {
        mContext = context;
...
//                    .bitmapTransform(new GlideRoundTransform(mContext,dp4))
    ...
    class CameraLiveDetailViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R2.id.iv_pic_item_adapter_alarm_camera_live_detail)
        ImageView ivPicItemAdapterAlarmCameraLiveDetail;
        @BindView(R2.id.iv_live_item_adapter_alarm_camera_live_detail)
        ImageView ivLiveItemAdapterAlarmCameraLiveDetail;
        @BindView(R2.id.tv_watch_state_item_adapter_alarm_camera_live_detail)
        TextView tvWatchStateItemAdapterAlarmCameraLiveDetail;
        @BindView(R2.id.tv_name_item_adapter_alarm_camera_live_detail)
        TextView tvNameItemAdapterAlarmCameraLiveDetail;
        @BindView(R2.id.tv_status_item_adapter_alarm_camera_live_detail)
        TextView tvStatusItemAdapterAlarmCameraLiveDetail;
        @BindView(R2.id.cl_root_item_adapter_alarm_camera_live_detail)
