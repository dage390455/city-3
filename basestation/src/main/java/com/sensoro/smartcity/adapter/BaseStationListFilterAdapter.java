...
public class BaseStationListFilterAdapter extends RecyclerView.Adapter<BaseStationListFilterAdapter.InspectionTaskStateSelectHolder> {
    ...
    public BaseStationListFilterAdapter(Context context) {
        mContext = context;
    }
    ...
    public void onBindViewHolder(final InspectionTaskStateSelectHolder holder, int position) {
        ...
        if (null != mStateCountList.get(position)) {
            ...
            if (!TextUtils.isEmpty(ic.getTitle())) {

                holder.itemPopTvSelectState.setText(ic.getTitle());
            }
