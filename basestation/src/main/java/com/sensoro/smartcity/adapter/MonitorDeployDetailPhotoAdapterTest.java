...
public class MonitorDeployDetailPhotoAdapterTest extends RecyclerView.Adapter<MonitorDeployDetailPhotoAdapterTest.AlarmDetailViewHolder> {
    ...
    public MonitorDeployDetailPhotoAdapterTest(Context mContext) {
