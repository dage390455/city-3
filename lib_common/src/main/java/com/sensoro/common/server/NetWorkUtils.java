...
public class NetWorkUtils {
    ...
    public static String GetNetworkType() {
        ...
        NetworkInfo networkInfo = ((ConnectivityManager) Objects.requireNonNull(ContextUtils.getContext().getSystemService(Context.CONNECTIVITY_SERVICE))).getActiveNetworkInfo();
