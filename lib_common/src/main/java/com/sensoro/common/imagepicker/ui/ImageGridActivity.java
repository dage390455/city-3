...
import com.sensoro.common.imagepicker.adapter.ImageFolderAdapter;
import com.sensoro.common.imagepicker.adapter.ImageRecyclerAdapter;
import com.sensoro.common.imagepicker.util.Utils;
import com.sensoro.common.imagepicker.view.FolderPopUpWindow;
import com.sensoro.common.imagepicker.view.GridSpacingItemDecoration;
import com.sensoro.common.model.ImageFolder;
import com.sensoro.common.model.ImageItem;
import com.sensoro.common.widgets.ProgressUtils;
import com.sensoro.common.R;
import com.sensoro.common.imagepicker.ImageDataSource;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[]
        ...
        if (requestCode == REQUEST_PERMISSION_STORAGE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                showToast(getString(R.string.permission_forbbidden_not_open_camera));
            }
        }
    }
