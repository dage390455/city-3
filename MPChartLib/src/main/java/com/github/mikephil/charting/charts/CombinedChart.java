...
public class CombinedChart extends BarLineChartBase<CombinedData> implements CombinedDataProvider {
    ...
    public enum DrawOrder {
        BAR, BUBBLE, LINE, CANDLE, SCATTER,CANDLE_SECOND
    }
    ...
    protected void init() {
        ...
        mDrawOrder = new DrawOrder[]{
                DrawOrder.BAR, DrawOrder.BUBBLE, DrawOrder.LINE, DrawOrder.CANDLE, DrawOrder.SCATTER, DrawOrder.CANDLE_SECOND
        };
    ...
    public CandleData getSecondCandleData() {
        if (mData == null)
            return null;
        return mData.getSecondCandleData();
    }
