...
public class CombinedData extends BarLineScatterCandleBubbleData<IBarLineScatterCandleBubbleDataSet<? extends Entry>> {
    ...
    private CandleData mSecondCandleData;
    private List<CandleData> mCandleDataList = new ArrayList<>();
    ...
    public void setSecondCandleData(CandleData data) {
        mSecondCandleData = data;
        notifyDataChanged();
    }
    ...
    public CandleData getSecondCandleData() {
        return mSecondCandleData;
    }

    public List<CandleData> getCandleDataList() {
        return mCandleDataList;
    }
    ...
    public List<BarLineScatterCandleBubbleData> getAllData() {
        ...
        if (mSecondCandleData != null) {
            data.add(mSecondCandleData);
        }
        return data;
    }
    ...
    public void notifyDataChanged() {
        ...
        if (mSecondCandleData != null)
            mSecondCandleData.notifyDataChanged();
        if (mScatterData != null)
