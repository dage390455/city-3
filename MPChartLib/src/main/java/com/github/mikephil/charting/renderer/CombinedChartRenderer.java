...
public class CombinedChartRenderer extends DataRenderer {
     ...
     */
    protected List<DataRenderer> mRenderers = new ArrayList<DataRenderer>(6);
        ...
        for (DrawOrder order : orders) {
            ...
            switch (order) {
                ...
                case CANDLE:
                    ...
                    break;
                case CANDLE_SECOND:
                    if (chart.getSecondCandleData() != null) {
                        mRenderers.add(new CandleStickSecondChartRenderer(chart, mAnimator, mViewPortHandler));
                    }
                    break;
                case SCATTER:
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (DataRenderer renderer : mRenderers) {
            ...
            else if (renderer instanceof CandleStickSecondChartRenderer)
                data = ((CandleStickSecondChartRenderer)renderer).mChart.getSecondCandleData();
