...
public class CandleStickSecondChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    public CandleStickSecondChartRenderer(CandleDataProvider chart, ChartAnimator animator,
    ...
    public void drawData(Canvas c) {
        ...
        CandleData candleData = mChart.getSecondCandleData();
    ...
    public void drawValues(Canvas c) {
        ...
        if (isDrawingValuesAllowed(mChart)) {
            ...
            List<ICandleDataSet> dataSets = mChart.getSecondCandleData().getDataSets();
