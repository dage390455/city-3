...
public class NameplateTestActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nameplate_test);
    ...
    private void requestPermissions(final String[] permissions) {
        AndPermission.with(this).runtime()
                    ...
                    public void showRationale(Context context, List<String> data, final RequestExecutor executor) {
                        ...
                        permissionDialogUtils.setTipMessageText(getString(R.string.permission_descript)).setTipConfirmText(getString(R.string.reauthorization),getResources().getColor(R.color.colorAccent)).show(new PermissionDialogUtils.TipDialogUtilsClickListener() {
                            ...
                            public void onCancelClick() {
                                ...
                                MyPermissionManager.restart(NameplateTestActivity.this);
                            }
                ...
                .onDenied(new Action<List<String>>() {
                    ...
                    public void onAction(List<String> data) {
                        // 用户拒绝权限，提示用户授权
                        if (AndPermission.hasAlwaysDeniedPermission(NameplateTestActivity.this, permissions)) {
                            // 如果用户勾选了禁止重复提醒，需要提示用户去到APP权限设置页面开启权限
                            String permissionTips = MyPermissionManager.getPermissionTips(data);
                            permissionDialogUtils.setTipConfirmText(NameplateTestActivity.this.getString(R.string.go_setting), NameplateTestActivity.this.getResources().getColor(R.color.c_f34a4a)).setTipMessageText(permissionTips + NameplateTestActivity.this.getString(R.string.permission_check)).show(new PermissionDialogUtils.TipDialogUtilsClickListener() {
                                @Override
                                public void onCancelClick() {
                                    permissionDialogUtils.dismiss();
                                    MyPermissionManager.restart(NameplateTestActivity.this);
                                ...
                                public void onConfirmClick() {
                                    permissionDialogUtils.dismiss();
                                    MyPermissionManager.startAppSetting(NameplateTestActivity.this);
                                }
                            });
                        } else {
