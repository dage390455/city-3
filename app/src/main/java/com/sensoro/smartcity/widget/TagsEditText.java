...
//    }
    ...
    private void init(@Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs == null) {
            ...
            mTagsTextColor = getColor(context, R.color.white);
            mTagsTextSize = ResourceUtils.getDimensionPixelSize(context, R.dimen.tag_default_size);
            mTagsBackground = ContextCompat.getDrawable(context, R.drawable.shape_textview);
            mRightDrawable = ContextCompat.getDrawable(context, R.mipmap.ic_text_del);
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.TagsEditText, defStyleAttr,
                    defStyleRes);
            try {
...
//        String str = editable.toString();
    ...
    private TextView createTextView(String text) {
        ClearableTextView textView = new ClearableTextView(getContext());
...
//        }
    ...
    private static final class Tag implements Parcelable {
        ...
        public boolean equals(Object obj) {
            return this.getSource().equalsIgnoreCase(((Tag) obj).getSource());
        }
    }
