...
import com.sensoro.smartcity.presenter.DeployForestCameraInstallPositionActivityPresenter;
...
public class DeployForestCameraInstallPositionActivity extends BaseActivity<IDeployForestCameraInstallPositionActivityView, DeployForestCameraInstallPositionActivityPresenter>
        implements IDeployForestCameraInstallPositionActivityView, RecycleViewItemClickListener, TipOperationDialogUtils.TipDialogUtilsClickListener {
    ...
    protected void onCreateInit(Bundle savedInstanceState) {
        setContentView(R.layout.activity_deploy_forest_camera_install_position);
    ...
    private void initView() {
        ...
        acWeChatRelationEt.setOnTouchListener(new View.OnTouchListener() {
            @Override
...
//        initEtWatcher();
    ...
    private void initTitle() {
        includeTextTitleTvTitle.setText(R.string.deploy_check_deploy_position);
    ...
    @Override
    protected DeployForestCameraInstallPositionActivityPresenter createPresenter() {
        return new DeployForestCameraInstallPositionActivityPresenter();
    }
