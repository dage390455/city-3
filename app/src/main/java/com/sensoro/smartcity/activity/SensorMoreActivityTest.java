...
public class SensorMoreActivityTest extends BaseActivity<ISensorMoreActivityViewTest, SensorMoreActivityPresenterTest> implements
        ISensorMoreActivityViewTest {
    ...
    @Override
    protected SensorMoreActivityPresenterTest createPresenter() {
        return new SensorMoreActivityPresenterTest();
    }
