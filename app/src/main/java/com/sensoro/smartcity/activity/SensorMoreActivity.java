...
public class SensorMoreActivity extends BaseActivity {
        ...
        try {
            if (response.getData().size() > 0 ) {
                ...
                if (batteryStruct != null) {
                    Object battery = batteryStruct.getValue();
    ...
    private void requestData() {
        ...
        sensoroCityApplication.smartCityServer.getDeviceDetailInfoList(sensor_sn, null, 1, new Response.Listener<DeviceInfoListRsp>() {
            @Override
    ...
    private void requestDataWithRecentAlarm() {
        SensoroCityApplication sensoroCityApplication = (SensoroCityApplication) getApplication();
        sensoroCityApplication.smartCityServer.getDeviceAlarmTime(snTextView.getText().toString(), new Response.Listener<DeviceAlarmTimeRsp>() {
            @Override
