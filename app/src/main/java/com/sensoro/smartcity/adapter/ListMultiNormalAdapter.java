...
//        }
        ...
        holder.gsyVideoPlayer.setUpLazy(list.get(position).url, true, null, null, "这是title");
        ...
        holder.gsyVideoPlayer.setVideoAllCallBack(new GSYSampleCallBack() {
            ...
            public void onPrepared(String url, Object... objects) {
                ...
                if (getListNeedAutoLand()) {
                    ...
                    ListMultiNormalAdapter.this.onPrepared();
                }
            }
            ...
            public void onQuitFullscreen(String url, Object... objects) {
                ...
                GSYVideoManager.instance().setNeedMute(true);
                if (getListNeedAutoLand()) {
                    ListMultiNormalAdapter.this.onQuitFullscreen();
                }
            }
            ...
            public void onAutoComplete(String url, Object... objects) {
                ...
                isFull = false;
                if (getListNeedAutoLand()) {
                    ListMultiNormalAdapter.this.onAutoComplete();
                }
            }
        });
