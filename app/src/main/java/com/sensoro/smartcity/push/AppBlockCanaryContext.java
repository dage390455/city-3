...
public class AppBlockCanaryContext extends BlockCanaryContext {
    ...
    public String provideUid() {
        if (TextUtils.isEmpty(PreferencesHelper.getInstance().getUserData().userId)) {
            return "uid";
        } else {
            return PreferencesHelper.getInstance().getUserData().userId;
        }
    }
    ...
    public List<String> provideWhiteList() {
        ...
        whiteList.add("com.sensoro.city");
        return whiteList;
    }
