...
public class DeployDeviceDetailActivityPresenter extends BasePresenter<IDeployDeviceDetailActivityView> implements IOnCreate, Constants, Runnable {
...
//                        getView().setContactEditText(mContext.getResources().getString(R.string.tips_hint_contact));
    ...
    private void freshPoint(DeviceDeployRsp deviceDeployRsp) {
        ...
        Intent intent = new Intent(mContext, DeployResultActivityTest.class);
