...
public class PreferencesSaveAnalyzer {
    ...
    private static void savePreferences(int status, String content) {
        switch (status) {
            ...
            case SearchHistoryTypeConstants.TYPE_SEARCH_HISTORY_DEPLOY_NAMEPLATE_NAME:
                SensoroCityApplication.getInstance().getSharedPreferences(SearchHistoryTypeConstants.SP_FILE_DEPLOY_NAMEPLATE_NAME, Context
                        .MODE_PRIVATE).edit().putString(SearchHistoryTypeConstants.SEARCH_HISTORY_KEY, content).apply();
                break;
    ...
    private static String obtainOldText(int status) {
        ...
        switch (status) {
            ...
            case SearchHistoryTypeConstants.TYPE_SEARCH_HISTORY_DEPLOY_ALARM_CONTRACT_PHONE:
                ...
                break;
            case SearchHistoryTypeConstants.TYPE_SEARCH_HISTORY_DEPLOY_NAMEPLATE_NAME:
                oldText = SensoroCityApplication.getInstance().getSharedPreferences(SearchHistoryTypeConstants.SP_FILE_DEPLOY_NAMEPLATE_NAME, Context
                        .MODE_PRIVATE).getString(SearchHistoryTypeConstants.SEARCH_HISTORY_KEY, "");
                break;
    ...
    public static void clearAllData(int status) {
        switch (status) {
            ...
            case SearchHistoryTypeConstants.TYPE_SEARCH_HISTORY_DEPLOY_NAMEPLATE_NAME:
                SensoroCityApplication.getInstance().getSharedPreferences(SearchHistoryTypeConstants.SP_FILE_DEPLOY_NAMEPLATE_NAME, Activity.MODE_PRIVATE)
                        .edit().clear().apply();
                break;
