...
public class ImageUtil {
    ...
    public static Bitmap createWaterMaskLeftTop(
        ...
        return createWaterMaskBitmap(src, watermark,
                AppUtils.dp2px(context, paddingLeft), AppUtils.dp2px(context, paddingTop));
    }
...
//                src.getHeight() - watermark.getHeight() - AppUtils.dp2px(context, paddingBottom));
    ...
    public static Bitmap createWaterMaskRightTop(
        ...
        return createWaterMaskBitmap(src, watermark,
                src.getWidth() - watermark.getWidth() - AppUtils.dp2px(context, paddingRight),
                AppUtils.dp2px(context, paddingTop));
    }
    ...
    public static Bitmap createWaterMaskLeftBottom(
        ...
        return createWaterMaskBitmap(src, watermark, AppUtils.dp2px(context, paddingLeft),
                src.getHeight() - watermark.getHeight() - AppUtils.dp2px(context, paddingBottom));
    }
