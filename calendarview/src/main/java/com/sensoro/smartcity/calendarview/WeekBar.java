 ...
 */
package com.sensoro.smartcity.calendarview;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.sensoro.smartcity.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.sensoro.smartcity.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
